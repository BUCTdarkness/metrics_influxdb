	...
	public void appendSeries(String namePrefix, String name, String nameSuffix, String[] columns, Object[][] points) {
		...
		for (int i = 0; i < points.length; i++) {
			...
			for (int j = 0; j < row.length; j++) {
				...
				else if (value instanceof Double && Double.isInfinite((double) ((Double) value).doubleValue()))
				{
					json.append("null");
				}
				else if (value instanceof Float && Float.isInfinite((float) ((Float) value).floatValue()))
				{
					json.append("null");
				}
				else {
